            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input type="text" class="form-control bg-primary text-white"
                  name="text_title" value="{{ old('text_title', $note->title) }}">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control bg-primary text-white" name="text_note"
                  rows="5">{{ old('text_note', $note->text) }}</textarea>
